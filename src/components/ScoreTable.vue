<template>
    <table>
        ...
        <tr>
            <td>Two's</td>
            <td>Count and add only two's</td>
            <td>{{ diceOfAKind }}</td>
            <td></td>
            <td></td>
            <td></td>
        ...
        <tr>
            <td>Three's</td>
            <td>Count and add only three's</td>
            <td>{{ diceOfAKind }}</td>
            <td></td>
            <td></td>
            <td></td>
        ...
        <tr>
            <td>Five's</td>
            <td>Count and add only Five's</td>
            <td>{{ diceOfAKind }}</td>
            <td></td>
            <td></td>
            <td></td>
